...
import ru.byazen.misc.TextureSlotBindings;
import ru.byazen.render.ClientRenderPipelines;
import ru.byazen.render.GpuKawaseBlurRenderer;
import ru.byazen.render.MaskTexture;
import ru.byazen.render.RenderFrameClock;
import ru.byazen.render.StencilMaskState;
import ru.byazen.util.GuiRenderDriver;

public final class ByAzenGlobals
implements GuiRenderDriver {
    ...
    public ByAzenGlobals(RenderPipeline renderPipeline) {
    ...
    public void drawIndexed(ByteBuffer byteBuffer, int n, ByteBuffer byteBuffer2, int n2) {
        ...
        byteBuffer5.flip();
        GpuBuffer gpuBuffer3 = RenderSystem.getDevice().createBuffer(() -> "wex/ByAzenGlobals", 128, byteBuffer5);
        if (this.stencilOperation == 1) {
            ...
            if (iiIlliiIlI2 != null) {
                ...
                try (RenderPass renderPass = RenderSystem.getDevice().createCommandEncoder().createRenderPass(() -> "wex/dc-mask", iiIlliiIlI2.target.view, optionalInt);){
                    ...
                    renderPass.setUniform("ByAzenGlobals", gpuBuffer3.slice());
