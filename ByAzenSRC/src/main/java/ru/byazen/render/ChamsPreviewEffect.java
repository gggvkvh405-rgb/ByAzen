...
final class ChamsPreviewEffect {
    ...
    private void ensureFramebuffers(int width, int height) {
        ...
        this.sceneFramebuffer = new class_6367("byazen_chams_preview_scene", width, height, true);
        this.effectFramebuffer = new class_6367("byazen_chams_preview_effect", width, height, false);
        this.width = width;
        this.height = height;
    }
