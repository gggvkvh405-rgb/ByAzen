...
import ru.byazen.render.GlowCompositeMode;
import ru.byazen.render.GlowOutlineCompositor;
import ru.byazen.render.RenderFrameState;
import ru.byazen.render.RenderTargetOverrideScope;
...
public final class GlowEspEffect {
    ...
    private void ensureFramebuffers() {
        this.maskFramebuffer = this.ensureFramebufferSize(this.maskFramebuffer, "byazen_glow_esp_mask", this.effectWidth, this.effectHeight, true);
        this.gradientFramebuffer = this.ensureFramebufferSize(this.gradientFramebuffer, "byazen_glow_esp_gradient", this.effectWidth, this.effectHeight, false);
        this.horizontalOutlineFramebuffer = this.ensureFramebufferSize(this.horizontalOutlineFramebuffer, "byazen_glow_esp_outline_temp", this.effectWidth, this.effectHeight, false);
        this.outlineFramebuffer = this.ensureFramebufferSize(this.outlineFramebuffer, "byazen_glow_esp_outline", this.effectWidth, this.effectHeight, false);
    }
