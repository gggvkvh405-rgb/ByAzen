...
public final class ClientRenderPipelines {
    ...
    private static class_2960 id(String path) {
        return class_2960.method_60655((String)"byazen", (String)path);
    }
}
