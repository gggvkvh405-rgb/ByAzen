...
import ru.byazen.util.ClientClock;
...
public final class ClientEventBridge {
    ...
    public static void renderHudAfterVanillaGui() {
        ...
        if (eventBus != null && context != null && tickCounter != null) {
            ...
            if (!(class_310.method_1551().field_1755 instanceof ByAzenScreen)) {
    ...
    private static void saveActiveConfig() {
        ...
        ConfigManager configManager = ByAzenClient.getConfigManager();
        ...
        try {
            ...
            ByAzenClient.getInstance().getLogger().warn("Unable to auto-save profile {}", (Object)profile, (Object)exception);
        }
    }
}
