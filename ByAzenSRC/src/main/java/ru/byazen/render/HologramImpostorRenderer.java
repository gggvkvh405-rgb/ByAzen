...
import ru.byazen.render.FramebufferTextureAdapter;
...
public final class HologramImpostorRenderer {
    ...
    private static final class_2960 CACHE_TEXTURE_ID = class_2960.method_60655((String)"byazen", (String)"hologram_impostor");
    ...
    private static CachedImpostor createImpostor(RenderRequest request) {
        ...
        class_6367 framebuffer = new class_6367("byazen_hologram_impostor", request.width() * quality, request.height() * quality, true);
    ...
    private static class_11278 projection() {
        if (projection == null) {
            projection = new class_11278("byazen_hologram_projection", -1000.0f, 1000.0f, true);
        }
        return projection;
    }
