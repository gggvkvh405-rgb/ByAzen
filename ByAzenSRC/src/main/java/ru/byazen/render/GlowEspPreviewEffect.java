...
final class GlowEspPreviewEffect {
    ...
    private void ensureFramebuffers(int width, int height) {
        ...
        this.gradientFramebuffer = new class_6367("byazen_glow_preview_gradient", width, height, false);
        this.horizontalOutlineFramebuffer = new class_6367("byazen_glow_preview_outline_temp", width, height, false);
        this.outlineFramebuffer = new class_6367("byazen_glow_preview_outline", width, height, false);
        this.width = width;
        this.height = height;
    }
