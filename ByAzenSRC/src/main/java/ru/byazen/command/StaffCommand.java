...
extends Command {
    ...
    public void execute(String ... stringArray) throws CommandUsageException {
        ...
        StaffNameStore staffNameStore2 = ByAzenClient.getInstance().getStaffNameStore();
    ...
    public List<String> complete(int n, String[] stringArray) {
        ...
        if (n == 1 && stringArray.length >= 1) {
            ...
            if (string.equals("remove") || string.equals("del") || string.equals("rm")) {
                ByAzenClient byAzenClient = ByAzenClient.getInstance();
                StaffNameStore staffNameStore2 = byAzenClient == null ? null : byAzenClient.getStaffNameStore();
