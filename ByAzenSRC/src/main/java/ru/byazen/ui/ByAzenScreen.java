...
public final class ByAzenScreen
extends class_437 {
    ...
    public ByAzenScreen() {
        this(ByAzenClient.getInstance().getMiscellaneous(), DeferredRenderTask::update);
    }

    public ByAzenScreen(MovablePanel root) {
        this(root, DeferredRenderTask::update);
    }

    ByAzenScreen(MovablePanel root, Runnable deferredRenderTaskRunner) {
