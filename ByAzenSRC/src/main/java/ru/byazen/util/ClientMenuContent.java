...
import ru.byazen.misc.MenuToolbar;
import ru.byazen.misc.ModuleCategoryNavigationEntry;
import ru.byazen.misc.MouseButtonHandler;
import ru.byazen.misc.MouseScrollHandler;
import ru.byazen.misc.NavigationSelectionListener;
...
import ru.byazen.util.UserProfilePanel;
...
BoundsProvider {
    ...
    public ClientMenuContent(GuiBounds bounds2, NavigationState navigationState, NavigationSelectionListener callback24, Runnable runnable, BooleanSupplier booleanSupplier) {
        ...
        this.value23 = 30.0f;
        this.value9 = 8.0f;
        this.userProfilePanel = new UserProfilePanel(new GuiBounds(6.0f, this.value23, 78.0f, this.value9), ByAzenClient.getInstance().getClientProfile());
    ...
    private float process8(float f, Matrix4f matrix4f, GuiBounds bounds2, float f2, float f3, float f4) {
        ...
        for (int i = 0; i < this.navigationSections.size(); ++i) {
            ...
            if (this.process3(i + 1) && f3 > 0.01f) {
                ...
                ByAzenClient.getGuiRenderer().fillRectangle(matrix4f, f8, f4 + f6, 6.0f, 0.5f, n2);
            }
    ...
    public float render(float f, Matrix4f matrix4f) {
        ...
        this.clippedContentRenderer.render(ByAzenClient.getGuiRenderer(), matrix4f, bounds2.getX(), f6, f3, f7, this.scrollController.getOffset(), this.scrollController.getMinimumOffset(f7), arg_0 -> this.member5202(contentBottom, f, bounds2, f3, f2, (Matrix4f)arg_0));
