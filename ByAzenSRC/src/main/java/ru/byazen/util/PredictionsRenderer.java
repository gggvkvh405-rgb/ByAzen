...
import ru.byazen.module.render.PredictionsModule;
import ru.byazen.prediction.ImpactQuad;
import ru.byazen.prediction.LandingPrediction;
import ru.byazen.prediction.LandingTimeLabel;
import ru.byazen.prediction.ModelOrientation;
import ru.byazen.prediction.PotionImpactMarker;
import ru.byazen.prediction.ProjectileImpact;
import ru.byazen.prediction.TrajectoryPrediction;
import ru.byazen.render.DepthSampler;
...
import ru.byazen.render.world.WorldLineRenderer;
...
import ru.byazen.util.ProjectileType;
import ru.byazen.util.TrajectoryPredictor;
...
public final class PredictionsRenderer {
    ...
    private static final class_2960 IMPACT_MARKER_TEXTURE = class_2960.method_60655((String)"byazen", (String)"textures/prediction/arrow_cross.png");
    ...
    public void onHudRender(HudRenderEvent gameEvent20) {
        ...
        GuiDrawApi drawApi = ByAzenClient.getHudRenderer();
