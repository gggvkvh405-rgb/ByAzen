...
BoundsProvider {
    ...
    public float render(float f, Matrix4f matrix4f2) {
        ...
        this.clippedContentRenderer.render(ByAzenClient.getGuiRenderer(), matrix4f2, bounds2.getX() - 3.0f, bounds2.getY(), bounds2.getWidth() + 6.0f, this.value2 + 3.0f, this.scrollController.getOffset(), this.scrollController.getMinimumOffset(this.value2), clippedMatrix -> {
