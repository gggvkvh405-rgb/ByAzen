...
import ru.byazen.config.LocalConfigEntry;
...
public final class LocalConfigCatalog {
    ...
    public void refresh() {
        ...
        if (directory != null && directory.isDirectory() && (files = directory.listFiles((ignored, name) -> name != null && name.endsWith(".byazen"))) != null) {
