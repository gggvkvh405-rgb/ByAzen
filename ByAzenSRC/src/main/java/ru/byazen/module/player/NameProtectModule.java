...
implements ConfigSerializable {
    ...
    public NameProtectModule(EventBus eventBus) {
        ...
        this.fakeName = ((TextSettingBuilder)TextSetting.getTextSettingBuilder().value("byazen").maxLength(32).name("\u041d\u0438\u043a").id("fake_name").description("\u041d\u0438\u043a\u043d\u0435\u0439\u043c, \u043a\u043e\u0442\u043e\u0440\u044b\u043c \u0437\u0430\u043c\u0435\u043d\u044f\u0435\u0442\u0441\u044f \u0442\u0432\u043e\u0439 \u043d\u0430\u0441\u0442\u043e\u044f\u0449\u0438\u0439")).build();
