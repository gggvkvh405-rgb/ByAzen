...
import ru.byazen.misc.AuctionHighlightSettings;
...
import ru.byazen.util.AuctionSlotHighlighter;
...
implements ConfigSerializable {
    ...
    protected void initialize() {
        ByAzenClient.getSlotHighlightRegistry().setCallback56(new AuctionSlotHighlighter(this::isEnabled, this::getAuctionHighlightSettings));
