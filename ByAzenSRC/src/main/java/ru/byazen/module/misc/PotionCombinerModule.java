...
import ru.byazen.module.misc.PotionCombinerRadialScreen;
...
implements ConfigSerializable {
    ...
    private void openRadialMenu(BindSetting ignored) {
        ...
        ByAzenClient byAzen = ByAzenClient.getInstance();
        PotionPresetController potionPresetController = combiner = byAzen == null ? null : byAzen.getPotionPresetController();
