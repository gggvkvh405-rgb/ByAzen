...
import ru.byazen.misc.MsdfAtlas;
import ru.byazen.misc.MsdfFont;
import ru.byazen.misc.MsdfFontData;
import ru.byazen.misc.MsdfGlyph;
import ru.byazen.misc.MsdfGlyphData;
import ru.byazen.misc.MsdfMetrics;
...
public class MsdfFontBuilder {
    ...
    private final ResourceResolver router = new ResourceResolver("/assets/byazen", ClasspathResource::new);
