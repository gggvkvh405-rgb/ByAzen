...
vec4 themeOutlineGradient(vec2 p, float blend) {
    ...
    vec4 c1 = vec4(mix(byazenClientPaletteLoop(base, fragXY), vec3(1.0), bright), 1.0);
    vec4 c2 = vec4(mix(byazenClientPaletteLoop(base + 0.25, fragXY), vec3(1.0), bright), 1.0);
    vec4 c3 = vec4(mix(byazenClientPaletteLoop(base + 0.5, fragXY), vec3(1.0), bright), 1.0);
    vec4 c4 = vec4(mix(byazenClientPaletteLoop(base + 0.75, fragXY), vec3(1.0), bright), 1.0);
