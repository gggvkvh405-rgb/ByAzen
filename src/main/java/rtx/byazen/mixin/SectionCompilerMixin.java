...
import rtx.byazen.utils.render.wave.WindWaveTagger;
...
public class SectionCompilerMixin {
    ...
    private void byazen_tagWavingVertices(BlockRenderManager dispatcher, BlockState state, BlockPos pos, BlockRenderView level, MatrixStack poseStack, VertexConsumer consumer, boolean checkSides, List<BlockModelPart> parts, Operation<Void> original) {
