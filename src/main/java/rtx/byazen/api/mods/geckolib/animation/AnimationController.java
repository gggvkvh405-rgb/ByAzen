package rtx.byazen.api.mods.geckolib.animation;
...
import rtx.byazen.api.mods.geckolib.animation.state.AnimationPoint;
import rtx.byazen.api.mods.geckolib.animation.state.AnimationTest;
import rtx.byazen.api.mods.geckolib.animation.state.AnimationTimeline;
import rtx.byazen.api.mods.geckolib.animation.state.AnimationTimeline.Stage;
...
import rtx.byazen.api.mods.geckolib.cache.animation.keyframeevent.CustomInstructionKeyframeData;
import rtx.byazen.api.mods.geckolib.cache.animation.keyframeevent.ParticleKeyframeData;
import rtx.byazen.api.mods.geckolib.cache.animation.keyframeevent.SoundKeyframeData;
import rtx.byazen.api.mods.geckolib.loading.math.MolangQueries;
import rtx.byazen.api.mods.geckolib.loading.math.MolangQueries.Actor;
...
import rtx.byazen.api.mods.geckolib.util.ClientUtil;
...
public class AnimationController<T extends GeoAnimatable> {
    ...
    public static interface KeyframeEventHandler<A extends GeoAnimatable, E> {
        public void handle(rtx.byazen.api.mods.geckolib.animation.state.KeyFrameEvent<A, E> var1);
    }
}
