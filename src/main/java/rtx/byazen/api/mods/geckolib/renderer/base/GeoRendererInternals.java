...
import rtx.byazen.api.mods.geckolib.renderer.base.PerBoneRender;
import rtx.byazen.api.mods.geckolib.renderer.base.RenderPassInfo;
import rtx.byazen.api.mods.geckolib.renderer.layer.GeoRenderLayer;
import rtx.byazen.api.mods.geckolib.util.ClientUtil;
import rtx.byazen.api.mods.geckolib.util.RenderUtil;

public interface GeoRendererInternals<T extends rtx.byazen.api.mods.geckolib.animatable.GeoAnimatable, O, R extends GeoRenderState> {
