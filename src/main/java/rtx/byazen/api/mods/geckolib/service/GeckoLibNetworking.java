package rtx.byazen.api.mods.geckolib.service;
...
import rtx.byazen.api.mods.geckolib.GeckoLibServices;
import rtx.byazen.api.mods.geckolib.animatable.SingletonGeoAnimatable;
import rtx.byazen.api.mods.geckolib.cache.SyncedSingletonAnimatableCache;
import rtx.byazen.api.mods.geckolib.constant.dataticket.SerializableDataTicket;
import rtx.byazen.api.mods.geckolib.network.packet.MultiloaderPacket;
import rtx.byazen.api.mods.geckolib.network.packet.blockentity.BlockEntityAnimTriggerPacket;
import rtx.byazen.api.mods.geckolib.network.packet.blockentity.BlockEntityDataSyncPacket;
import rtx.byazen.api.mods.geckolib.network.packet.blockentity.StatelessBlockEntityPlayAnimPacket;
import rtx.byazen.api.mods.geckolib.network.packet.blockentity.StatelessBlockEntityStopAnimPacket;
import rtx.byazen.api.mods.geckolib.network.packet.blockentity.StopTriggeredBlockEntityAnimPacket;
import rtx.byazen.api.mods.geckolib.network.packet.entity.EntityAnimTriggerPacket;
import rtx.byazen.api.mods.geckolib.network.packet.entity.EntityDataSyncPacket;
import rtx.byazen.api.mods.geckolib.network.packet.entity.StatelessEntityPlayAnimPacket;
import rtx.byazen.api.mods.geckolib.network.packet.entity.StatelessEntityStopAnimPacket;
import rtx.byazen.api.mods.geckolib.network.packet.entity.StopTriggeredEntityAnimPacket;
import rtx.byazen.api.mods.geckolib.network.packet.singleton.SingletonAnimTriggerPacket;
import rtx.byazen.api.mods.geckolib.network.packet.singleton.SingletonDataSyncPacket;
import rtx.byazen.api.mods.geckolib.network.packet.singleton.StatelessSingletonPlayAnimPacket;
import rtx.byazen.api.mods.geckolib.network.packet.singleton.StatelessSingletonStopAnimPacket;
import rtx.byazen.api.mods.geckolib.network.packet.singleton.StopTriggeredSingletonAnimPacket;
