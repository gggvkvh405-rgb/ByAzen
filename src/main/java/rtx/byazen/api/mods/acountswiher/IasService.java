package rtx.byazen.api.mods.acountswiher;
import java.util.List;
import java.util.concurrent.CompletableFuture;
import net.fabricmc.loader.api.FabricLoader;
import rtx.byazen.api.mods.acountswiher.ru.vidtu.ias.IAS;
import rtx.byazen.api.mods.acountswiher.ru.vidtu.ias.account.Account;
import rtx.byazen.api.mods.acountswiher.ru.vidtu.ias.account.OfflineAccount;
import rtx.byazen.api.mods.acountswiher.ru.vidtu.ias.auth.LoginData;
import rtx.byazen.api.mods.acountswiher.ru.vidtu.ias.auth.handlers.LoginHandler;
import rtx.byazen.api.mods.acountswiher.ru.vidtu.ias.config.IASConfig;
import rtx.byazen.api.mods.acountswiher.ru.vidtu.ias.config.IASStorage;
