...
public final class ThemeManager {
    ...
    private static Theme current = Theme.BYAZEN;
    private static int[] currentShades = Theme.BYAZEN.shades();
    private static float[] fromShades = ThemeManager.unpack(Theme.BYAZEN.shades());
    private static int[] fromPalette = Theme.BYAZEN.palette();
