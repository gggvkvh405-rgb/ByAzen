...
extends BaseScreen {
    ...
    private static void initToggleAnim(Decelerate anim, boolean val) {
        if (anim != null) {
            anim.setDirection(val ? rtx.byazen.utils.animations.Direction.FORWARDS : rtx.byazen.utils.animations.Direction.BACKWARDS);
        }
    }
}
