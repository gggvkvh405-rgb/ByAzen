...
implements Setting {
    private final rtx.byazen.api.modules.settings.impl.ColorSetting backend;
    ...
    public ColorSetting(rtx.byazen.api.modules.settings.impl.ColorSetting colorSetting) {
