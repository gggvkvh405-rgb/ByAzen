...
implements Setting {
    private final rtx.byazen.api.modules.settings.impl.MultiSelectSetting backend;
    private boolean open;
    private final Decelerate dropAnim;

    public MultiSelectSetting(rtx.byazen.api.modules.settings.impl.MultiSelectSetting multiSelectSetting) {
