...
implements Setting {
    ...
    private final rtx.byazen.api.modules.settings.impl.SelectSetting backend;
    ...
    public SelectSetting(rtx.byazen.api.modules.settings.impl.SelectSetting selectSetting) {
