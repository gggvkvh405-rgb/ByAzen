...
implements Setting {
    ...
    private final rtx.byazen.api.modules.settings.impl.SeparatorSetting backend;

    public SeparatorSetting(rtx.byazen.api.modules.settings.impl.SeparatorSetting separatorSetting) {
