...
implements Setting {
    private final rtx.byazen.api.modules.settings.impl.SliderSetting backend;
    ...
    public SliderSetting(rtx.byazen.api.modules.settings.impl.SliderSetting sliderSetting) {
