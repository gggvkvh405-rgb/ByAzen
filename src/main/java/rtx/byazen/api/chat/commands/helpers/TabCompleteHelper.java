package rtx.byazen.api.chat.commands.helpers;
...
public class TabCompleteHelper {
    ...
    public TabCompleteHelper addCommands(rtx.byazen.api.chat.commands.CommandManager cm) {
        if (cm != null) {
            for (rtx.byazen.api.chat.commands.Command c : cm.getCommands()) {
