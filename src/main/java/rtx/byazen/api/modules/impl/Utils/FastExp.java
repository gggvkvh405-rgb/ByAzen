...
import rtx.byazen.mixin.accessor.MinecraftAccessor;
...
extends Module {
    ...
    public void onTick(TickEvent tickEvent) {
        ...
        ((MinecraftAccessor)(Object)this.mc).byazen_setRightClickDelay(0);
        ((LivingEntityAccessor)(Object)this.mc.player).byazen_setAttackAnim(0.0f);
    }
}
