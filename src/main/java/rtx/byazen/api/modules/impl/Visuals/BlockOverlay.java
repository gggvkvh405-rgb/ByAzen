...
import rtx.byazen.mixin.accessor.MultiPlayerGameModeAccessor;
...
import rtx.byazen.utils.render.world.BlockOverlayRenderer;
...
extends Module {
    ...
    private void onTick(TickEvent tickEvent) {
        ...
        BlockPos blockPos = multiPlayerGameModeAccessor.byazen_getDestroyBlockPos();
        float f = multiPlayerGameModeAccessor.byazen_getDestroyProgress();
        boolean bl = multiPlayerGameModeAccessor.byazen_isDestroying() || f > 0.0f && f != this.previousRawProgress;
