...
extends Module {
    ...
    private void saveReport() {
        ...
        ArrayList<String> arrayList = new ArrayList<String>();
        arrayList.add("\u041e\u0442\u0447\u0451\u0442 ByAzen Profiler");
        ...
        try {
            ...
            ByAzen.LOGGER.info("[Profiler] Saved report to {}", (Object)path2);
        }
        catch (IOException iOException) {
            ByAzen.LOGGER.error("[Profiler] Failed to save report to {}", (Object)path2, (Object)iOException);
        }
    }
