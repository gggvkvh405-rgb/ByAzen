...
import rtx.byazen.api.drags.RenderUnderHand;
...
import rtx.byazen.utils.render.render2d.msdf.GlyphNormalizer;
...
extends Module {
    ...
    private static final String ICON_FONT = "byazen";
    ...
    private void onWorldRender(WorldRenderEvent worldRenderEvent) {
        ...
        for (PlayerEntity playerEntity : this.mc.world.getPlayers()) {
            ...
            boolean bl4 = bl2 && ClientPresence.INSTANCE.isByAzenUser(playerEntity.getGameProfile().name());
