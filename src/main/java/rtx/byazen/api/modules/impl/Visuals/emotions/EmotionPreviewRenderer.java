...
import rtx.byazen.mixin.emotions.PictureInPictureRendererAccessor;
...
extends SpecialGuiElementRenderer<EmotionPreviewState> {
    ...
    protected String getName() {
        return "byazen emotion previews";
    }
    ...
    protected void blitTexture(EmotionPreviewState emotionPreviewState, GuiRenderState guiRenderState) {
        GpuTextureView gpuTextureView = ((PictureInPictureRendererAccessor)((Object)this)).byazen_textureView();
