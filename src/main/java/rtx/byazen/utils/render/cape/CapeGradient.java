package rtx.byazen.utils.render.cape;
...
public final class CapeGradient {
    private static final Identifier BASE_TEXTURE = Identifier.of((String)"byazen", (String)"textures/capes/cape.png");
    private static final Identifier DYNAMIC_TEXTURE = Identifier.of((String)"byazen", (String)"dynamic/cape_gradient");
    private static final Identifier DYNAMIC_ASSET_ID = Identifier.of((String)"byazen", (String)"capes/cape_gradient");
    public static final AssetInfo.TextureAsset STATIC_ASSET = new AssetInfo.TextureAssetInfo(Identifier.of((String)"byazen", (String)"capes/cape"), BASE_TEXTURE);
    ...
    private static void ensureInit() {
        ...
        try {
            ...
            texture = new NativeImageBackedTexture(() -> "byazen_cape_gradient", work);
            ...
            failed = true;
            ByAzen.LOGGER.error("[CapeGradient] init failed, falling back to plain cape", throwable);
        }
    }
    ...
    private static void recolor(boolean bl) {
        ...
        try {
            ...
            failed = true;
            ByAzen.LOGGER.error("[CapeGradient] upload failed, falling back to plain cape", throwable);
        }
    }
}
