package rtx.byazen.utils.render.render2d.effecticon;
...
import rtx.byazen.utils.render.render2d.effecticon.EffectIconQuad;
import rtx.byazen.utils.render.render2d.effecticon.EffectIconRenderState;
import rtx.byazen.utils.render.render2d.effecticon.EffectIconTexture;
...
implements AutoCloseable {
    ...
    private void submit(DrawContext drawContext, BuiltEffectIcon builtEffectIcon) {
        ...
        try {
            ...
            ByAzen.LOGGER.warn("[EffectIconRenderer] Failed to submit effect icon", (Throwable)runtimeException);
        }
    }
