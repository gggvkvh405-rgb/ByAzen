package rtx.byazen.utils.render.render2d.image;
...
import rtx.byazen.utils.render.render2d.image.ImageQuad;
import rtx.byazen.utils.render.render2d.image.ImageRenderState;
import rtx.byazen.utils.render.render2d.image.ImageTexture;
...
implements AutoCloseable {
    ...
    private void submit(DrawContext drawContext, BuiltImage builtImage) {
        ...
        try {
            ...
            ByAzen.LOGGER.warn("[ImageRenderer] Failed to submit image: {}", (Object)builtImage.texture(), (Object)runtimeException);
        }
    }
    ...
    private GpuBuffer ensureWritableParamsBuffer() {
        ...
        this.closeParamsBuffer();
        try {
            this.paramsBuffer = RenderSystem.getDevice().createBuffer(() -> "byazen_image_params", 136, 49152L);
            return this.paramsBuffer;
        }
        catch (RuntimeException runtimeException) {
            return null;
    ...
    private Identifier resolveIdentifier(String string) {
        ...
        return Identifier.of((String)"byazen", (String)object);
    }
