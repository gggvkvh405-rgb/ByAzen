...
import rtx.byazen.utils.render.render2d.arc.BuiltArc;
import rtx.byazen.utils.render.render2d.blur.BlurBuilder;
import rtx.byazen.utils.render.render2d.blur.BlurFramebuffer;
import rtx.byazen.utils.render.render2d.blur.BuiltBlur;
import rtx.byazen.utils.render.render2d.circle.BuiltCircle;
import rtx.byazen.utils.render.render2d.circle.CircleRenderer;
import rtx.byazen.utils.render.render2d.effecticon.BuiltEffectIcon;
import rtx.byazen.utils.render.render2d.effecticon.EffectIconRenderer;
import rtx.byazen.utils.render.render2d.font.BuiltText;
import rtx.byazen.utils.render.render2d.font.TextRenderer;
import rtx.byazen.utils.render.render2d.glass.BuiltGlass;
...
import rtx.byazen.utils.render.render2d.image.BuiltImage;
import rtx.byazen.utils.render.render2d.image.ImageRenderer;
import rtx.byazen.utils.render.render2d.line.BuiltLine;
import rtx.byazen.utils.render.render2d.line.LineRenderer;
import rtx.byazen.utils.render.render2d.msdf.BuiltMsdfText;
import rtx.byazen.utils.render.render2d.msdf.MsdfTextRenderer;
import rtx.byazen.utils.render.render2d.outline.outline360.BuiltOutline360;
import rtx.byazen.utils.render.render2d.outline.outline360.Outline360Range;
import rtx.byazen.utils.render.render2d.outline.outline360.Outline360Renderer;
import rtx.byazen.utils.render.render2d.outline.outlinedefault.BuiltOutline;
import rtx.byazen.utils.render.render2d.outline.outlinedefault.DefaultOutlineRenderer;
import rtx.byazen.utils.render.render2d.outline.outlineglass.BuiltGlassOutline;
import rtx.byazen.utils.render.render2d.outline.outlineglass.GlassOutlineRenderer;
import rtx.byazen.utils.render.render2d.picker.BuiltPicker;
import rtx.byazen.utils.render.render2d.picker.PickerRenderer;
import rtx.byazen.utils.render.render2d.radialglass.BuiltRadialGlass;
import rtx.byazen.utils.render.render2d.radialglass.RadialGlassRenderer;
import rtx.byazen.utils.render.render2d.rectangle.rectdefault.BuiltRectangle;
import rtx.byazen.utils.render.render2d.rectangle.rectdefault.DefaultRectangleRenderer;
import rtx.byazen.utils.render.render2d.rectangle.recthalficon.BuiltHalfIconRectangle;
import rtx.byazen.utils.render.render2d.rectangle.recthalficon.HalfIconRectangleRenderer;
import rtx.byazen.utils.render.render2d.rectangle.recthalftone.BuiltHalftoneRectangle;
import rtx.byazen.utils.render.render2d.rectangle.recthalftone.HalftoneRectangleRenderer;
import rtx.byazen.utils.render.render2d.ripple.BuiltRipple;
...
import rtx.byazen.utils.render.render2d.shape.BuiltShape;
import rtx.byazen.utils.render.render2d.shape.ShapeRenderer;
import rtx.byazen.utils.render.render2d.shimmer.BuiltShimmer;
import rtx.byazen.utils.render.render2d.shimmer.ShimmerRenderer;
import rtx.byazen.utils.render.render2d.zippy.BuiltZippy;
...
public final class Render2D {
    ...
    public static void close() {
        ...
        ByAzen.LOGGER.info("[Render2D] Render2D closed");
    }

    public static void init() {
        Render2D.registerReloadListener();
        ByAzen.LOGGER.info("[Render2D] Render2D initialized");
    }
    ...
    private static void registerReloadListener() {
        ...
        Identifier identifier = Identifier.of((String)"byazen", (String)"render2d_msdf_cache");
