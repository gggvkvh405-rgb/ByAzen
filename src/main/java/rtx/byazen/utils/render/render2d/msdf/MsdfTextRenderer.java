package rtx.byazen.utils.render.render2d.msdf;
...
import rtx.byazen.utils.render.render2d.msdf.MsdfGlyph;
import rtx.byazen.utils.render.render2d.msdf.MsdfTextRenderState;
...
implements AutoCloseable {
    ...
    private void submit(DrawContext drawContext, BuiltMsdfText builtMsdfText, boolean bl, float f, float f2, float f3, float f4, boolean bl2, float f5) {
        ...
        try {
            ...
            ByAzen.LOGGER.warn("[MSDF] Failed to submit text: {}", (Object)builtMsdfText.text(), (Object)runtimeException);
        }
    }
