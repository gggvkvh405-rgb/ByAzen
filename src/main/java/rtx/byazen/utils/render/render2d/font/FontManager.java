...
implements AutoCloseable {
    ...
    private static final String FONT_ROOT = "/assets/byazen/fonts/";
    ...
    private Font loadFont(String string, Font font) {
        try (InputStream inputStream = FontManager.class.getResourceAsStream(FONT_ROOT + string);){
            if (inputStream == null) {
                ByAzen.LOGGER.debug("[FontRenderer] Font asset not found, using fallback: {}", (Object)string);
                return font;
            }
            ...
            ByAzen.LOGGER.warn("[FontRenderer] Failed to load font asset: {}", (Object)string, (Object)exception);
            return font;
        }
    }
