package rtx.byazen.utils.render.post.hpfocus;
...
public final class HPFocusRenderer {
    public static final String TEXTURE_KEY = "byazen:hpfocus_scene";
    private static final Identifier TEXTURE_ID = Identifier.of((String)"byazen", (String)"hpfocus_scene");
    private static final Identifier PIPELINE_ID = Identifier.of((String)"byazen", (String)"pipeline/post/hpfocus/copy");
    private static final Identifier COPY_SHADER = Identifier.of((String)"byazen", (String)"post/hpfocus/copy");
    ...
    private static boolean ensureInitialized() {
        ...
        try {
            ...
            pipeline = null;
            ByAzen.LOGGER.error("[HPFocus] failed to initialise copy pipeline", throwable);
            return false;
        }
    }
    ...
    public static void captureIfRequested() {
        ...
        try {
            ...
            try (RenderPass renderPass = commandEncoder.createRenderPass(() -> "byazen:hpfocus_copy", outTarget.getColorAttachmentView(), OptionalInt.empty());){
            ...
            ByAzen.LOGGER.error("[HPFocus] scene capture failed, disabling", throwable);
        }
    }
    ...
    private static void ensureResources(int n, int n2) {
        ...
        HPFocusRenderer.closeResources();
        sceneCopyTexture = RenderSystem.getDevice().createTexture(() -> "byazen:hpfocus_scene_copy", 5, TextureFormat.RGBA8, n, n2, 1, 1);
