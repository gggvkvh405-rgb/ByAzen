...
import rtx.byazen.utils.animations.Easing;
...
public final class RectUtil {
    ...
    public static void drawClientRectSplit(float f, float f2, float f3, float f4, float f5, float f6, int n, boolean bl, float f7, float f8, float f9, float f10) {
        ...
        float f13 = interfaceModule == null ? 18.0f : interfaceModule.rectBackdropBlur.getFloat();
        int n2 = interfaceModule == null ? -857872385 : interfaceModule.clientPrimaryColor();
        ...
        float f16 = interfaceModule == null ? 0.18f : interfaceModule.rectEdgeStrength.getFloat();
        float f17 = interfaceModule == null ? 55.0f : interfaceModule.rectEdgeSharpness.getFloat();
        float f18 = interfaceModule == null ? 0.3f : interfaceModule.rectRefractionStrength.getFloat();
    ...
    private static void drawClientRectImpl(float f, float f2, float f3, float f4, float f5, float f6, float f7, boolean bl, boolean bl2) {
        ...
        float f19 = interfaceModule == null ? 0.3f : interfaceModule.rectRefractionStrength.getFloat();
        float f20 = 0.5f;
        if (bl) {
            RectUtil.drawGlow(interfaceModule, f, f2, f3, f4, f10, f8, n, n2, f16);
        }
        BuiltGlass builtGlass = new BuiltGlass(f, f2, f3, f4, f10, f10, f10, f10, n, f8 * f13, f18, n, f14 * f12, true, f17, f19, f20, 0.0f).withBlurRadius(f11).withSecondColor(n2, f16);
        Render2D.glass(builtGlass);
    }
