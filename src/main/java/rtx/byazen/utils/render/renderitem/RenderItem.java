...
import rtx.byazen.utils.render.renderitem.CustomItemRenderer;
import rtx.byazen.utils.render.renderitem.RenderItemOptions;
...
public final class RenderItem {
    ...
    public static void close() {
        ...
        ByAzen.LOGGER.info("[RenderItem] RenderItem closed");
    }

    public static void init() {
        RenderItem.registerReloadListener();
        ByAzen.LOGGER.info("[RenderItem] RenderItem initialized");
    }
    ...
    private static void registerReloadListener() {
        ...
        Identifier identifier = Identifier.of((String)"byazen", (String)"render_item_cache");
