...
public final class SoundManager {
    ...
    public static final SoundEvent COSMETIC_EQUIP = SoundManager.sound("cosmetic_equip");
    public static final SoundEvent COSMETIC_UNEQUIP = SoundManager.sound("cosmetic_unequip");
    public static final SoundEvent COSMETIC_FAVORITE = SoundManager.sound("cosmetic_favorite");
    public static final SoundEvent COSMETIC_CLAIM_SET = SoundManager.sound("cosmetic_claim_set");
    public static final SoundEvent COSMETIC_SET_WINTER = SoundManager.sound("cosmetic_set_winter");
    public static final SoundEvent COSMETIC_SET_NEON = SoundManager.sound("cosmetic_set_neon");
    public static final SoundEvent COSMETIC_SET_SPACE = SoundManager.sound("cosmetic_set_space");
    public static final SoundEvent PET_FEED = SoundManager.sound("pet_feed");
    public static final SoundEvent PET_PET = SoundManager.sound("pet_pet");
    public static final SoundEvent PET_TOY = SoundManager.sound("pet_toy");
    public static final SoundEvent PET_LEVEL = SoundManager.sound("pet_level");
    private static final SoundEvent[] ALL_SOUNDS = new SoundEvent[]{MOAN1, MOAN2, MOAN3, MOAN4, CRIME, METALLIC, MODULE_ENABLE, MODULE_DISABLE, ON, OFF, MODULE_ENABLE_TYPE2, MODULE_DISABLE_TYPE2, SEARCH_TYPING, SLIDER, SETTINGS_SLIDER, SWITCH_CATEGORY, NO_SETTINGS, BUTTON_CLICK, UNKNOWN_COMMAND, COMMAND_ERROR, OPEN_GUI, CLOSE_GUI, SELECT_CATEGORY, NOTIFICATION, NOTIFICATION_LOW, PLAYER_PING, MINE, ACCOUNT_SWITCH, SWITCH_LEFT, SWITCH_RIGHT, SETTINGS_OPEN, SETTINGS_CLOSE, GUI_CATEGORY_SELECT, RIBBIT_AMBIENT, RIBBIT_STEP, RIBBIT_HURT, RIBBIT_DEATH, NOTIFICATION_DIRECT, LOW, PLAYERPING, ON_DIRECT, OFF_DIRECT, FRAG_EFFECT_ECHO_MAIN, FRAG_EFFECT_KNOCK_MAIN, FRAG_EFFECT_PULSE, FRAG_EFFECT_SPARKS_COLLISION, SWITCH_CATEGORY_SELECT, SWITCH_LEFT_DIRECT, SWITCH_RIGHT_DIRECT, SETTINGS_OPEN_DIRECT, SETTINGS_CLOSE_DIRECT, MODULE_SETTINGS_OPEN, MODULE_SETTINGS_CLOSE, TOGGLE1_ON, TOGGLE1_OFF, RIBBIT_AMBIENT1, RIBBIT_AMBIENT2, RIBBIT_AMBIENT3, RIBBIT_AMBIENT4, RIBBIT_AMBIENT5, RIBBIT_STEP1, RIBBIT_STEP2, RIBBIT_HURT1, RIBBIT_HURT2, RIBBIT_HURT3, RIBBIT_DEATH1, RIBBIT_DEATH2, COSMETIC_EQUIP, COSMETIC_UNEQUIP, COSMETIC_FAVORITE, COSMETIC_CLAIM_SET, COSMETIC_SET_WINTER, COSMETIC_SET_NEON, COSMETIC_SET_SPACE, PET_FEED, PET_PET, PET_TOY, PET_LEVEL};
