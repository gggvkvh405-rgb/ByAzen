package rtx.byazen.utils.network;
...
import rtx.byazen.mixin.accessor.BossHealthOverlayAccessor;
...
public final class Network {
    ...
    private static void updatePvpState(long l) {
        ...
        Map<UUID, ClientBossBar> map = ((BossHealthOverlayAccessor)Network.MC.inGameHud.getBossBarHud()).byazen_getEvents();
