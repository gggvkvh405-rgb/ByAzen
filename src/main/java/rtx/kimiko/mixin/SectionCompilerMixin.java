...
import rtx.kimiko.utils.render.wave.WindWaveTagger;
...
public class SectionCompilerMixin {
    ...
    private void kimiko_tagWavingVertices(BlockRenderManager dispatcher, BlockState state, BlockPos pos, BlockRenderView level, MatrixStack poseStack, VertexConsumer consumer, boolean checkSides, List<BlockModelPart> parts, Operation<Void> original) {
