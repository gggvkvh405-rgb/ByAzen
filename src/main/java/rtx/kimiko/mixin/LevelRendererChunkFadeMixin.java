...
public abstract class LevelRendererChunkFadeMixin {
    ...
    private DynamicUniforms.ChunkSectionsValue kimiko_fullSectionVisibility(Matrix4fc matrix, int x, int y, int z, float visibility, int a, int b, Operation<DynamicUniforms.ChunkSectionsValue> original) {
