...
import rtx.kimiko.api.chat.commands.impl.ConfigCommand;
import rtx.kimiko.api.chat.commands.impl.HelpCommand;
import rtx.kimiko.api.chat.commands.impl.IrcCommand;
...
public final class CommandManager {
    ...
    public void init() {
        ...
        Kimiko.LOGGER.info("[CommandManager] Initialized with {} commands, prefix '{}'", (Object)this.commands.size(), (Object)this.prefix);
    }
    ...
    public void executeRaw(String string) {
        ...
        try {
            ...
            Kimiko.LOGGER.error("[CommandManager] Error executing command '{}'", (Object)string2, (Object)exception);
        }
    }
