...
public final class ConfigManager {
        ...
        block13: {
            ...
            if (!Files.exists(configPath)) {
                ...
                if (Files.exists(triaPath)) {
                    ...
                    Path jsonPath = FabricLoader.getInstance().getGameDir().resolve("kimiko").resolve("autocfg.json");
            ...
            try (BufferedReader reader = Files.newBufferedReader(configPath)) {
                ...
                Kimiko.LOGGER.error("[ConfigManager] Failed to read module config", (Throwable)exception);
                return new JsonObject();
            }
        }
        return jsonObject;
    ...
    private static Path moduleConfigPath() {
        return RepositoryStorage.root().resolve("autocfg.kimiko");
    }
    ...
    private static void saveModules(boolean bl) {
        ...
        try {
            ...
            Kimiko.LOGGER.error("[ConfigManager] Failed to save module config", (Throwable)exception);
        }
    }
    ...
    public static List<String> listProfiles() {
        ...
        try (Stream<Path> stream = Files.list(path2);){
            ...
            Kimiko.LOGGER.error("[ConfigManager] Failed to list profiles", (Throwable)exception);
        }
    ...
    public static void saveProfile(String string) {
        ...
        try {
            ...
            Kimiko.LOGGER.error("[ConfigManager] Failed to save profile {}", (Object)string, (Object)exception);
        }
    }
    ...
    public static void loadProfile(String string) {
        ...
        try (BufferedReader bufferedReader = Files.newBufferedReader(path);){
            ...
            Kimiko.LOGGER.error("[ConfigManager] Failed to load profile {}", (Object)string, (Object)exception);
        }
        finally {
            ConfigManager.INSTANCE.loading = false;
        }
    ...
    private static void resetSetting(Setting setting) {
        try {
            ...
            Kimiko.LOGGER.warn("[ConfigManager] Failed to reset setting {}", (Object)setting.getName(), (Object)exception);
        }
    }
    ...
    public static void deleteProfile(String string) {
        try {
            ...
            Kimiko.LOGGER.error("[ConfigManager] Failed to delete profile {}", (Object)string, (Object)exception);
        }
    }
    ...
    private static void applySetting(Setting setting, JsonElement jsonElement) {
        try {
            ...
            Kimiko.LOGGER.warn("[ConfigManager] Failed to apply setting {}", (Object)setting.getName(), (Object)exception);
        }
    }
    ...
    public static void resetToFactory() {
        ...
        try {
            ...
            Kimiko.LOGGER.error("[ConfigManager] Failed to delete active config during reset", (Throwable)exception);
        }
        ConfigManager.saveModules(true);
    }
