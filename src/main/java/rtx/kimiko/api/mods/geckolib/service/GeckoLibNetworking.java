package rtx.kimiko.api.mods.geckolib.service;
...
import rtx.kimiko.api.mods.geckolib.GeckoLibServices;
import rtx.kimiko.api.mods.geckolib.animatable.SingletonGeoAnimatable;
import rtx.kimiko.api.mods.geckolib.cache.SyncedSingletonAnimatableCache;
import rtx.kimiko.api.mods.geckolib.constant.dataticket.SerializableDataTicket;
import rtx.kimiko.api.mods.geckolib.network.packet.MultiloaderPacket;
import rtx.kimiko.api.mods.geckolib.network.packet.blockentity.BlockEntityAnimTriggerPacket;
import rtx.kimiko.api.mods.geckolib.network.packet.blockentity.BlockEntityDataSyncPacket;
import rtx.kimiko.api.mods.geckolib.network.packet.blockentity.StatelessBlockEntityPlayAnimPacket;
import rtx.kimiko.api.mods.geckolib.network.packet.blockentity.StatelessBlockEntityStopAnimPacket;
import rtx.kimiko.api.mods.geckolib.network.packet.blockentity.StopTriggeredBlockEntityAnimPacket;
import rtx.kimiko.api.mods.geckolib.network.packet.entity.EntityAnimTriggerPacket;
import rtx.kimiko.api.mods.geckolib.network.packet.entity.EntityDataSyncPacket;
import rtx.kimiko.api.mods.geckolib.network.packet.entity.StatelessEntityPlayAnimPacket;
import rtx.kimiko.api.mods.geckolib.network.packet.entity.StatelessEntityStopAnimPacket;
import rtx.kimiko.api.mods.geckolib.network.packet.entity.StopTriggeredEntityAnimPacket;
import rtx.kimiko.api.mods.geckolib.network.packet.singleton.SingletonAnimTriggerPacket;
import rtx.kimiko.api.mods.geckolib.network.packet.singleton.SingletonDataSyncPacket;
import rtx.kimiko.api.mods.geckolib.network.packet.singleton.StatelessSingletonPlayAnimPacket;
import rtx.kimiko.api.mods.geckolib.network.packet.singleton.StatelessSingletonStopAnimPacket;
import rtx.kimiko.api.mods.geckolib.network.packet.singleton.StopTriggeredSingletonAnimPacket;
