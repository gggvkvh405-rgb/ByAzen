...
import rtx.kimiko.api.mods.geckolib.renderer.base.PerBoneRender;
import rtx.kimiko.api.mods.geckolib.renderer.base.RenderPassInfo;
import rtx.kimiko.api.mods.geckolib.renderer.layer.GeoRenderLayer;
import rtx.kimiko.api.mods.geckolib.util.ClientUtil;
import rtx.kimiko.api.mods.geckolib.util.RenderUtil;

public interface GeoRendererInternals<T extends rtx.kimiko.api.mods.geckolib.animatable.GeoAnimatable, O, R extends GeoRenderState> {
