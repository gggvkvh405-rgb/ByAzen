package rtx.kimiko.api.mods.geckolib.event.entity;
import net.fabricmc.fabric.api.event.Event;
import net.fabricmc.fabric.api.event.EventFactory;
import rtx.kimiko.api.mods.geckolib.event.GeoRenderEvent;
import rtx.kimiko.api.mods.geckolib.renderer.GeoEntityRenderer;

public class CompileEntityRenderLayersEvent<T extends net.minecraft.entity.Entity & rtx.kimiko.api.mods.geckolib.animatable.GeoAnimatable, R extends net.minecraft.client.render.entity.state.EntityRenderState & rtx.kimiko.api.mods.geckolib.renderer.base.GeoRenderState>
