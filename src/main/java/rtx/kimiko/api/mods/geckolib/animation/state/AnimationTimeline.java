package rtx.kimiko.api.mods.geckolib.animation.state;
import it.unimi.dsi.fastutil.objects.ObjectArrayList;
import java.util.List;
import net.minecraft.util.math.MathHelper;
import rtx.kimiko.api.mods.geckolib.animatable.GeoAnimatable;
import rtx.kimiko.api.mods.geckolib.animation.AnimationController;
import rtx.kimiko.api.mods.geckolib.animation.AnimationController.KeyframeEventHandler;
import rtx.kimiko.api.mods.geckolib.animation.AnimationProcessor;
import rtx.kimiko.api.mods.geckolib.animation.RawAnimation;
import rtx.kimiko.api.mods.geckolib.animation.RawAnimation.Stage;
import rtx.kimiko.api.mods.geckolib.animation.object.EasingType;
import rtx.kimiko.api.mods.geckolib.animation.object.LoopType;
import rtx.kimiko.api.mods.geckolib.animation.state.AnimationPoint;
import rtx.kimiko.api.mods.geckolib.animation.state.KeyFrameEvent;
...
import rtx.kimiko.api.mods.geckolib.cache.animation.keyframeevent.KeyFrameData;
