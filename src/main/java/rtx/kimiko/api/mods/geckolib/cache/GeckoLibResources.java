package rtx.kimiko.api.mods.geckolib.cache;
...
import rtx.kimiko.api.mods.geckolib.cache.BakedAnimationCache;
import rtx.kimiko.api.mods.geckolib.cache.BakedModelCache;
import rtx.kimiko.api.mods.geckolib.cache.animation.Animation;
import rtx.kimiko.api.mods.geckolib.cache.animation.Animation.KeyframeMarkers;
import rtx.kimiko.api.mods.geckolib.cache.model.BakedGeoModel;
import rtx.kimiko.api.mods.geckolib.loading.definition.geometry.GeometryDescription;
import rtx.kimiko.api.mods.geckolib.loading.json.ModelFormatVersion;
import rtx.kimiko.api.mods.geckolib.loading.json.raw.Bone;
import rtx.kimiko.api.mods.geckolib.loading.json.raw.Cube;
import rtx.kimiko.api.mods.geckolib.loading.json.raw.FaceUV;
import rtx.kimiko.api.mods.geckolib.loading.json.raw.LocatorClass;
import rtx.kimiko.api.mods.geckolib.loading.json.raw.LocatorValue;
import rtx.kimiko.api.mods.geckolib.loading.json.raw.MinecraftGeometry;
import rtx.kimiko.api.mods.geckolib.loading.json.raw.Model;
import rtx.kimiko.api.mods.geckolib.loading.json.raw.PolyMesh;
import rtx.kimiko.api.mods.geckolib.loading.json.raw.PolysUnion;
import rtx.kimiko.api.mods.geckolib.loading.json.raw.TextureMesh;
import rtx.kimiko.api.mods.geckolib.loading.json.raw.UVFaces;
import rtx.kimiko.api.mods.geckolib.loading.json.raw.UVUnion;
import rtx.kimiko.api.mods.geckolib.loading.json.typeadapter.BakedAnimationsAdapter;
import rtx.kimiko.api.mods.geckolib.loading.json.typeadapter.KeyFrameMarkersAdapter;
import rtx.kimiko.api.mods.geckolib.loading.math.value.Constant;
import rtx.kimiko.api.mods.geckolib.loading.object.BakedAnimations;
import rtx.kimiko.api.mods.geckolib.loading.object.BakedModelFactory;
import rtx.kimiko.api.mods.geckolib.loading.object.GeometryTree;
