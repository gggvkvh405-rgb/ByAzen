package rtx.kimiko.api.mods.geckolib.animation;
...
import rtx.kimiko.api.mods.geckolib.animation.object.EasingType;
import rtx.kimiko.api.mods.geckolib.animation.object.PlayState;
import rtx.kimiko.api.mods.geckolib.animation.state.AnimationPoint;
import rtx.kimiko.api.mods.geckolib.animation.state.AnimationTest;
import rtx.kimiko.api.mods.geckolib.animation.state.AnimationTimeline;
import rtx.kimiko.api.mods.geckolib.animation.state.AnimationTimeline.Stage;
...
import rtx.kimiko.api.mods.geckolib.cache.animation.keyframeevent.CustomInstructionKeyframeData;
import rtx.kimiko.api.mods.geckolib.cache.animation.keyframeevent.ParticleKeyframeData;
import rtx.kimiko.api.mods.geckolib.cache.animation.keyframeevent.SoundKeyframeData;
import rtx.kimiko.api.mods.geckolib.loading.math.MolangQueries;
import rtx.kimiko.api.mods.geckolib.loading.math.MolangQueries.Actor;
...
import rtx.kimiko.api.mods.geckolib.util.ClientUtil;
...
public class AnimationController<T extends GeoAnimatable> {
    ...
    public static interface KeyframeEventHandler<A extends GeoAnimatable, E> {
        public void handle(rtx.kimiko.api.mods.geckolib.animation.state.KeyFrameEvent<A, E> var1);
    }
}
