package rtx.kimiko.api.mods.waveycapes;
...
import rtx.kimiko.api.mods.waveycapes.NMSUtil;
import rtx.kimiko.api.mods.waveycapes.VanillaCapeRenderer;
import rtx.kimiko.api.mods.waveycapes.WaveyCapesBase;
import rtx.kimiko.api.mods.waveycapes.compat.MathUtil;
import rtx.kimiko.api.mods.waveycapes.compat.PlayerWrapper;
import rtx.kimiko.api.mods.waveycapes.compat.VertexConsumerUtil;
import rtx.kimiko.api.mods.waveycapes.support.ModSupport;
import rtx.kimiko.api.mods.waveycapes.support.SupportManager;
import rtx.kimiko.api.mods.waveycapes.versionless.CapeHolder;
import rtx.kimiko.api.mods.waveycapes.versionless.CapeMovement;
import rtx.kimiko.api.mods.waveycapes.versionless.CapeStyle;
import rtx.kimiko.api.mods.waveycapes.versionless.ModBase;
import rtx.kimiko.api.mods.waveycapes.versionless.sim.BasicSimulation;
import rtx.kimiko.api.mods.waveycapes.versionless.util.Vector3;
import rtx.kimiko.api.mods.waveycapes.versionless.util.Vector4;
