...
import rtx.kimiko.utils.render.post.killdistortion.KillDistortionRenderer;
...
extends Module {
    ...
    private static final Identifier VIGNETTE_TEXTURE = Identifier.of((String)"kimiko", (String)"textures/effects/frag/lightarroundscreen_alpha.png");
