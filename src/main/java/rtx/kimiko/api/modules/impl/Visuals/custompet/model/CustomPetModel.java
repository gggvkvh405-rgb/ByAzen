...
extends GeoModel<CustomPetEntity> {
    public static final DataTicket<Boolean> UMBRELLA = DataTicket.create("kimiko_custom_pet.umbrella", Boolean.class);
    public static final DataTicket<Boolean> AIRBORNE = DataTicket.create("kimiko_custom_pet.airborne", Boolean.class);
    public static final DataTicket<String> VARIANT = DataTicket.create("kimiko_custom_pet.variant", String.class);
    public static final DataTicket<Integer> ROBOT_TYPE = DataTicket.create("kimiko_custom_pet.robot_type", Integer.class);
    public static final DataTicket<Boolean> OWL = DataTicket.create("kimiko_custom_pet.owl", Boolean.class);
