...
public final class ThemeManager {
    ...
    private static Theme current = Theme.KIMIKO;
    private static int[] currentShades = Theme.KIMIKO.shades();
    private static float[] fromShades = ThemeManager.unpack(Theme.KIMIKO.shades());
    private static int[] fromPalette = Theme.KIMIKO.palette();
