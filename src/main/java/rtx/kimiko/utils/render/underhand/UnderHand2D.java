package rtx.kimiko.utils.render.underhand;
...
import rtx.kimiko.utils.render.render2d.msdf.MsdfQuadLayout;
import rtx.kimiko.utils.render.render2d.msdf.MsdfTextRenderer;
...
public final class UnderHand2D {
    ...
    public void nativeText(Text text, float f, float f2, float f3, int n) {
        ...
        try {
            ...
            Kimiko.LOGGER.error("[UnderHand2D] nativeText failed", throwable);
        }
        finally {
    ...
    private GpuBuffer ensureVertexBuffer(String string, int n) {
        ...
        GpuBuffer gpuBuffer2 = RenderSystem.getDevice().createBuffer(() -> "kimiko:underhand_vb_" + string, 40, (long)n2);
    ...
    private void drawPending() {
        ...
        try {
            ...
            Kimiko.LOGGER.error("[UnderHand2D] flush failed", throwable);
            this.discardBuilders();
        }
    }
    ...
    private void drawMesh(CommandEncoder commandEncoder, Framebuffer framebuffer, String string, BuiltBuffer builtBuffer, RenderPipeline renderPipeline, GpuTextureView gpuTextureView, GpuBufferSlice gpuBufferSlice, GpuBufferSlice gpuBufferSlice2) {
        ...
        try {
            ...
            try (RenderPass renderPass = commandEncoder.createRenderPass(() -> "kimiko:underhand_" + string, framebuffer.getColorAttachmentView(), OptionalInt.empty());){
