package rtx.kimiko.utils.render.post.guimotionblur;
...
public final class GuiMotionBlurRenderer {
    ...
    private static void ensureTargets(GpuDevice gpuDevice, int n, int n2, float f) {
        ...
        maskTarget = new SimpleFramebuffer("kimiko_gui_motion_blur_mask", n, n2, false);
        horizontalTarget = new SimpleFramebuffer("kimiko_gui_motion_blur_scene_h", n, n2, false);
        verticalTarget = new SimpleFramebuffer("kimiko_gui_motion_blur_scene_result", n, n2, false);
        backgroundHorizontalTarget = new SimpleFramebuffer("kimiko_gui_motion_blur_bg_h", n, n2, false);
        backgroundVerticalTarget = new SimpleFramebuffer("kimiko_gui_motion_blur_bg_result", n, n2, false);
        sourceWidth = n;
        sourceHeight = n2;
        blurWidth = n;
        blurHeight = n2;
    ...
    private static void disableAfterError(Throwable throwable) {
        Kimiko.LOGGER.error("[GuiMotionBlur] disabled after render error", throwable);
        backgroundCaptured = false;
        GuiMotionBlurRenderer.releaseResources();
