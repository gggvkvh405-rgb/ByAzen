...
public final class RenderCompatibility {
    ...
    private static final String SAFE_WORLD_EFFECTS_PROPERTY = "kimiko_safeWorldEffects";
    ...
    private static final String DISABLE_FRAG_EFFECT_SCAN_PROPERTY = "kimiko_disableFragEffectScanShader";
