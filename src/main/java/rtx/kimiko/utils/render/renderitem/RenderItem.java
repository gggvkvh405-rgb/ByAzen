...
import rtx.kimiko.utils.render.renderitem.CustomItemRenderer;
import rtx.kimiko.utils.render.renderitem.RenderItemOptions;
...
public final class RenderItem {
    ...
    public static void close() {
        ...
        Kimiko.LOGGER.info("[RenderItem] RenderItem closed");
    }

    public static void init() {
        RenderItem.registerReloadListener();
        Kimiko.LOGGER.info("[RenderItem] RenderItem initialized");
    }
    ...
    private static void registerReloadListener() {
        ...
        Identifier identifier = Identifier.of((String)"kimiko", (String)"render_item_cache");
