...
import rtx.kimiko.utils.render.render2d.msdf.BuiltMsdfText;
...
public final class Render2D {
    ...
    public static void close() {
        ...
        Kimiko.LOGGER.info("[Render2D] Render2D closed");
    }

    public static void init() {
        Render2D.registerReloadListener();
        Kimiko.LOGGER.info("[Render2D] Render2D initialized");
    }
