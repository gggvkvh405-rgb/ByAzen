...
implements AutoCloseable {
    ...
    private void submit(DrawContext drawContext, BuiltImage builtImage) {
        ...
        try {
            ...
            Kimiko.LOGGER.warn("[ImageRenderer] Failed to submit image: {}", (Object)builtImage.texture(), (Object)runtimeException);
        }
    }
    ...
    private GpuBuffer ensureWritableParamsBuffer() {
        ...
        this.closeParamsBuffer();
        try {
            this.paramsBuffer = RenderSystem.getDevice().createBuffer(() -> "kimiko_image_params", 136, 49152L);
            return this.paramsBuffer;
        }
        catch (RuntimeException runtimeException) {
            return null;
