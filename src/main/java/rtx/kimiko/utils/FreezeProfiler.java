        ...
        Thread thread = new Thread(() -> {
            ...
            while (true) {
                ...
                if (l2 > 400L) {
                    ...
                    Kimiko.LOGGER.warn(stringBuilder.toString());
                    l = l2;
                    continue;
                }
                if (l <= 0L) continue;
                Kimiko.LOGGER.warn("[FREEZE-PROF] recovered after ~{}ms freeze", (Object)l);
                l = -1L;
            }
        }, "kimiko-freeze-profiler");
