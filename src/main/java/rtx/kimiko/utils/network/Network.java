...
import rtx.kimiko.mixin.accessor.BossHealthOverlayAccessor;
...
public final class Network {
    ...
    private static void updatePvpState(long l) {
        ...
        Map<UUID, ClientBossBar> map = ((BossHealthOverlayAccessor)Network.MC.inGameHud.getBossBarHud()).kimiko_getEvents();
